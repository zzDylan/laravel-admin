...
<div class="portlet light bordered">
    ...
    <div class="portlet-body">
        <div id="toolbar">
            ...
            @if(Auth::guard('admin')->user()->checkPermission('permission.delete')) <a class="btn btn-danger remove">删除</a> @endif
        </div>
...
<script>
    ...
    function getSelectionIds() {
        ...
        return [
                '',
                @if(Auth::guard('admin')->user()->checkPermission('permission.edit'))  '<a class="edit btn btn-warning" href="javascript:void(0)" title="编辑">', '<i class="fa fa-edit"></i>', '</a>  ', @endif
                @if(Auth::guard('admin')->user()->checkPermission('permission.create'))  '<a class="removeOne btn btn-danger" href="javascript:void(0)" title="删除">', '<i class="fa fa-trash"></i>', '</a>  ', @endif
                ''
        ].join('');
    }
